...
const WhyUs = () => {
  return (
    <section className="flex w-full items-center justify-center m-auto h-auto">
      <div className="flex flex-col lg:flex-row items-center justify-center rounded-[1rem] border-[3px] border-purple-900 p-10 bg-purple-100 mx-5 mb-20 overflow-hidden h-full relative">
        {/* Left Text Section */}
        <div className="lg:w-1/2 mb-8 lg:mb-0 overflow-hidden h-full flex flex-col justify-center">
          <p className="text-purple-600 font-semibold text-sm mb-2">
            Your Future Starts Here
          </p>
          <h1 className="text-3xl lg:text-5xl font-bold text-gray-800 mb-6 leading-snug">
          ...
          <div className="w-full h-[100px]">
            <Link href="#"  className=" bg-purple-800 py-3 px-4 text-white rounded-[1rem] shadow hover:bg-purple-900 transition ">Start Challenges</Link>
          </div>
        </div>

        {/* Right Image Section */}
        <div className="w-full h-[500px] lg:w-1/2 relative flex items-center justify-center">
          <Globe />
        </div>
      </div>
    </section>
